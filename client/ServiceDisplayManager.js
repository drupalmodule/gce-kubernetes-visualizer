        ...
        obj.Update = function(services) {
                ...
                for (var i in services) {
                    ...
                    $servicesContainer.append(
                            ...
                            '<div class="serviceText">cPort: ' + s.ContainerPort +'<br/>ExLB: ' + s.ExternalLoadBalancer + '<br/>selectors:' + selectors + '</div>' +
                            '</div>');


                    //$servicesContainer.append('<div class="service" id=service-' + s.Id + '> Service: ' + s.Id + ' port: ' + s.Port + ' containerPort: ' + s.ContainerPort + ' ExternalLoadBalancer: ' + s.ExternalLoadBalancer + ' labels: ' + s.Labels + ' selectors: ' + s.Selectors + '</div>' );
                }
        }
        return obj;
